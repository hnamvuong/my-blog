                        ...
                        <form role="form" enctype="multipart/form-data" @submit.prevent="updatePost()">
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="postId">Update Title Post </label>
                                    <input type="text" class="form-control" id="postId" placeholder="Update Title Post"
                                           v-model="form.title" name="title"
                                           :class="{ 'is-invalid': form.errors.has('title') }">
                                    <has-error :form="form" field="title"></has-error>
                                </div>
                                <div class="form-group">
                                    <label for="descriptionId">Update Description Post</label>
                            ...
                            <div class="card-footer">
                                <router-link class="btn btn-danger" to="/post-list">Back</router-link>
...
<script>
    export default {
        ...
        methods: {
            ...
            updatePost() {
                this.form.put(`/post/${this.$route.params.postId}`)
                    .then(() => {
